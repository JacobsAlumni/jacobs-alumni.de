        ...
        return <Layout title="Homecoming 2020" extraClassName={styles.wrapper}>
            <div className="uk-alert-primary" uk-alert="">
                ...
                <p>
                    ...
                    This page is about the 2020 Homecoming Event.
                    It is available for historical purposes.
                    Please see the <Link href="/homecoming/2021"><a>2021 Homecoming Page</a></Link> for information about the current homecoming.
                </p>
            </div>
            <div className="row">
